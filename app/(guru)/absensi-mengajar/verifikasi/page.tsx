...
function VerifikasiMengajarContent() {
  ...
  const handleSubmit = () => {
    router.push("/absensi-mengajar/berhasil");
  };

  const backHref = `/absensi-mengajar/${tingkat}/${kelasId}/${hari}/foto`;
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#EEF2F7] px-6 pt-12 pb-10">
      ...
      {/* ── KARTU DATA VERIFIKASI (Sesuai Figma) ── */}
      ...
      {/* ── PREVIEW FOTO SELFIE (Sesuai Figma) ── */}
      {photoUrl && (
